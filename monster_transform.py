...
def transformThreadStart(self):
    ...
    # data checking before starting transform
    ...
    self.transformThread = TransformThread(self, str(self.processed_location.text()), calibPath, detectorData, self.t_files_to_process, self.addToFolder, 0)
