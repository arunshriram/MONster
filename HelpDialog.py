...
class HelpDialog(QWidget):
    ...
    def stack2UI(self):
        ...
        data_source.append("   - To select one or more files, click the \"Select one or more files\" button and select your files. To select multiple, click one file, hold shift, and click another file.")
    ...
    def stack4UI(self):
        ...
        howto.append("   - To select one or more files, click the \"Select one or more files\" button and select your files. To select multiple, click one file, hold shift, and click another file.")
