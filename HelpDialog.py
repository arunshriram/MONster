...
class HelpDialog(QWidget):
    ...
    def updateUi(self):
        ...
        self.leftlist.setFixedSize(self.leflist.sizeHint().width(), self.leftlist.sizeHint().height())
    ...
    def stack2UI(self):
        ...
        data_source.append("   - If you wish to select an entire folder, check the \"I'm going to select a folder\" checkbox, and click the folder icon.")
        data_source.append("   - To select one or more files, uncheck the \"I'm going to select a folder\" checkbox, click the folder icon, and select your files. To select multiple, click one file, hold shift, and click another file.")
    ...
    def stack4UI(self):
        ...
        howto = QTextBrowser()
        howto.setFont(QFont("Calibri", 18))
        howto.append("   - If you wish to select an entire folder for your data, check the \"I'm going to select a folder\" checkbox, and click the folder icon.")
        howto.append("   - To select one or more files, uncheck the \"I'm going to select a folder\" checkbox, click the folder icon, and select your files. To select multiple, click one file, hold shift, and click another file.")
    ...
    def stack6UI(self):
        ...
        menu.append("File:")
        menu.append("   - By default, MONster will save the console output for each day of usage in a folder called \"console_messages\". To switch this feature off, click the Toggle button under File.")
        menu.append("Edit:")
