...
class HelpDialog(QWidget):
    def __init__(self, win):
        ...
        self.win = win
        self.Stack = QStackedWidget (self) # The general widget with several layers
        self.stack0 = QWidget() # welcome
        self.stack1 = QWidget() # macros
        self.stack2 = QWidget() # transform
        self.stack3 = QWidget() # stitch
        self.stack4 = QWidget() # integrate
        self.stack5 = QTabWidget() # queue loader
        self.stack6 = QWidget() # other
    ...
    # None -> None
    # Defines the layout for the stitch screen of the help dialog
    ...
    def stack3UI(self):
        ...
        layout.addWidget(howto)
        note = QLabel("Note: Unfortunately, if you would like to stitch images taken with different detector positions, you will have to supply the correct calibration file for each image and transform them individually.")
        layout.addWidget(note)
        
        self.stack3.setLayout(layout)

    # None -> None
    # Defines the layout for the integrate screen of the help dialog
