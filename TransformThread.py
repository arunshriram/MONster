# 
# This file defines the main scientific and mathematic functions behind transforming raw and .tif data
...
#
#
from PyQt4.QtCore import * # for any necessary GUI stuff
from PyQt4.QtGui import *
import glob, os, time, re, random, time, pyFAI, csv # processing
import numpy as np # math 
#####################################################################

from os.path import basename
from image_loader import load_image # function to load .raw and .tif data and convert into a numpy 2d array
from saveDimRedPack import save_Qchi # save the 2darray as a qchi plot
from scipy import signal
import shutil # for removing/overwriting folders
###############################################################
...
class TransformThread(QThread):
    ...
    def __init__(self, windowreference, processedPath, calibPath, detectorData, files_to_process, addToFolder, increment):
    ...
    # All signals are defined in the functions defined in monster_transform
    def beginTransform(self):
        QApplication.processEvents()
        # collecting correct files from user's given list
